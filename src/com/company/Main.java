...
public class Main {
    ...
    public static BufferedWriter OpenBuffWr() throws IOException {
        ...
        File file = new File(".\\.\\.\\Fichier\\XML_Modifier.xml");
    ...
    public static void ecritureEntete(BufferedWriter bw) throws IOException {
        bw.write("<!DOCTYPE infos SYSTEM \"infos.dtd\">\n");
